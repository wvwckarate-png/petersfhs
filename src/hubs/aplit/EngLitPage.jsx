...
const MCQ_STORAGE_KEY = "englit-hub-mcq-progress-v1";
const NAV_STORAGE_KEY = "englit-hub-last-nav-v1";
...
export default function EngLitPage() {
  ...
  const unitData = QUESTIONS[unitId];
  const questions = Array.isArray(unitData) ? unitData : (unitData?.items || []);
  const passages = Array.isArray(unitData) ? [] : (unitData?.passages || []);
  ...
  const allMissed = useMemo(() => {
    const list = [];
    UNITS.forEach((u) => {
      const uData = QUESTIONS[u.id];
      const qs = Array.isArray(uData) ? uData : (uData?.items || []);
      qs.forEach((q) => {
  ...
  return (
    <div style={S.page}>
      <style>{getEngineCSS(ENGLIT_COLORS)}</style>
      {/* TOP BAR */}
      <div style={S.topbar}>
          ...
          <div style={S.logoRow}>
            <div style={S.logoMark}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                <path d="M3.5 19.5V4.5H8.5V19.5H3.5Z" stroke="#2E4568" strokeWidth="1.6" strokeLinejoin="round"/>
                <path d="M9.5 19.7L9.9 5.3L14.8 5.9L14 20L9.5 19.7Z" stroke="#3E5C8A" strokeWidth="1.6" strokeLinejoin="round" transform="rotate(-4 12 12)"/>
                <path d="M15.5 19.5V6.5H20.5V19.5H15.5Z" stroke="#2E4568" strokeWidth="1.6" strokeLinejoin="round"/>
                <path d="M2.5 19.5H21.5" stroke="#2E4568" strokeWidth="1.8" strokeLinecap="round"/>
              </svg>
            </div>
            <div>
              <div style={S.logoText}>AP English Literature Hub</div>
        ...
        {mode !== "dashboard" && !globalReview && (
          <button style={S.unitSwitcher} className="mobile-only-switcher" onClick={() => setSidebarOpen(true)}>
            ...
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
              <path d="M4 6L12 14L20 6" stroke="#2E4568" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </button>
        )}
                ...
                return (
                  <>
                    ...
                    {q.passageId && (() => {
                      ...
                      return (
                        <div style={S.passageCard}>
                          <div style={S.passageLabel}>{passage.title}</div>
                          {passage.intro && <p style={S.passageIntro}>{passage.intro}</p>}
                          <p style={S.passageText}>{passage.text}</p>
                        </div>
                      );
                    })()}
...
const S = {
  ...
  logoMark: { width: 36, height: 36, borderRadius: 11, background: "#E9EDF5", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 },
  ...
  modePillActive: { background: "#3E5C8A", color: "white" },
  ...
  unitSwitcherNum: { fontFamily: "'IBM Plex Mono',monospace", fontSize: 11.5, color: "#2E4568", fontWeight: 700 },
  ...
  unitBtnActive: { background: "#E9EDF5", border: "1px solid #B8D1AE" },
  unitBtnTop: { display: "flex", justifyContent: "space-between", marginBottom: 3 },
  unitNum: { fontFamily: "'IBM Plex Mono',monospace", fontSize: 10.5, color: "#2E4568", fontWeight: 700 },
  ...
  miniFill: { height: "100%", background: "#3E5C8A" },
  ...
  progressText: { fontFamily: "'Nunito',sans-serif", fontWeight: 700, fontSize: 13.5, color: "#2E4568" },
  progressTrack: { height: 7, background: "#E6E9E3", borderRadius: 4, overflow: "hidden" },
  progressFill: { height: "100%", background: "#3E5C8A", transition: "width 0.3s ease" },
  ...
  qNavBtn: { fontFamily: "'Nunito',sans-serif", fontWeight: 700, fontSize: 13.5, background: "#FFFFFF", color: "#2E4568", border: "1px solid #ECEAE3", padding: "10px 18px", borderRadius: 100, cursor: "pointer", boxShadow: "0 2px 8px rgba(70,90,60,0.05)" },
  ...
  unitBadge: { fontFamily: "'IBM Plex Mono',monospace", fontSize: 10.5, fontWeight: 700, color: "#2E4568", background: "#D6DFEE", borderRadius: 8, padding: "4px 8px", whiteSpace: "nowrap" },
  ...
  reviewAllCardClear: { background: "#E9EDF5" },
  reviewAllIconClear: { color: "#2E4568" },
  ...
  filterPillActive: { background: "#3E5C8A", color: "white" },
  ...
  passageCard: { background: "#FFFFFF", border: "1px solid #ECEAE3", borderRadius: 16, padding: "18px 20px", marginBottom: 14, boxShadow: "0 2px 8px rgba(70,90,60,0.04)" },
  passageLabel: { fontFamily: "'Manrope',sans-serif", fontWeight: 800, fontSize: 14.5, color: "#2E4568", marginBottom: 8 },
  passageIntro: { fontSize: 13, fontStyle: "italic", color: "#767F73", marginBottom: 10 },
  passageText: { fontSize: 14.5, lineHeight: 1.7, color: "#3B4038", whiteSpace: "pre-line" },
  ...
  qNumBadge: { fontFamily: "'IBM Plex Mono',monospace", fontSize: 11.5, fontWeight: 700, color: "#2E4568", background: "#D6DFEE", borderRadius: 8, padding: "4px 8px" },
  ...
  choiceCorrect: { background: "#E1EEDD", border: "1px solid #3E5C8A" },
  choiceWrong: { background: "#FBEAE5", border: "1px solid #D98B7B" },
  choiceDisabled: { opacity: 0.5, cursor: "default" },

  explanation: { marginTop: 14, padding: "13px 16px", background: "#E9EDF5", borderRadius: 12 },
  explanationLabel: { fontFamily: "'Nunito',sans-serif", fontWeight: 700, fontSize: 11, letterSpacing: "0.06em", textTransform: "uppercase", color: "#2E4568", marginBottom: 6 },
  ...
  frqPartLabel: { fontFamily: "'IBM Plex Mono',monospace", fontWeight: 700, fontSize: 12.5, color: "#2E4568", background: "#E9EDF5", display: "inline-block", padding: "3px 10px", borderRadius: 100, marginBottom: 8 },
  ...
  emptyIconBadge: { width: 56, height: 56, borderRadius: 18, background: "#E9EDF5", color: "#2E4568", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 16px" },
  ...
  dashCardValue: { fontFamily: "'Manrope',sans-serif", fontWeight: 800, fontSize: 28, color: "#2E4568" },
  ...
  dashUnitFill: { height: "100%", background: "#3E5C8A" },
  dashUnitActions: { display: "flex", gap: 8, marginTop: "auto" },
  dashJumpBtn: { fontFamily: "'Nunito',sans-serif", fontWeight: 700, fontSize: 12, background: "#E9EDF5", color: "#2E4568", border: "none", borderRadius: 100, padding: "6px 14px", cursor: "pointer" },
