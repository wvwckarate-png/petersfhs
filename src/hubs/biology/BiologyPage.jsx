          ...
          <div style={S.logoRow}>
            <div style={S.logoMark}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                <path d="M3 21V3" stroke="#6B5A80" strokeWidth="1.8" strokeLinecap="round"/>
                <path d="M3 21H21" stroke="#6B5A80" strokeWidth="1.8" strokeLinecap="round"/>
                <path d="M3.5 17C7 17 8 6 13 6C17 6 16.5 13 20.5 13" stroke="#9887B0" strokeWidth="1.8" strokeLinecap="round" fill="none"/>
              </svg>
            </div>
            <div>
