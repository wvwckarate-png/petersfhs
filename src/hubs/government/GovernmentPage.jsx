...
const MCQ_STORAGE_KEY = "government-hub-mcq-progress-v1";
const NAV_STORAGE_KEY = "government-hub-last-nav-v1";
          ...
          <div style={S.logoRow}>
            <div style={S.logoMark}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                <path d="M3 21V3" stroke="#7A2E34" strokeWidth="1.8" strokeLinecap="round"/>
                <path d="M3 21H21" stroke="#7A2E34" strokeWidth="1.8" strokeLinecap="round"/>
                <path d="M3.5 17C7 17 8 6 13 6C17 6 16.5 13 20.5 13" stroke="#A8434B" strokeWidth="1.8" strokeLinecap="round" fill="none"/>
              </svg>
            </div>
            <div>
              <div style={S.logoText}>AP US Government Hub</div>
