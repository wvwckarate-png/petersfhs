...
const PHYSICS1_COLORS = {
  sage: "#7BA3B8", sageDeep: "#4F7A8F", sagePale: "#E5EFF3", sagePill: "#CCE1EA",
};

const MCQ_STORAGE_KEY = "physics1-hub-mcq-progress-v1";
const NAV_STORAGE_KEY = "physics1-hub-last-nav-v1";
...
export default function Physics1Page() {
  ...
  return (
    <div style={S.page}>
      <style>{getEngineCSS(PHYSICS1_COLORS)}</style>
      {/* TOP BAR */}
      <div style={S.topbar}>
          ...
          <div style={S.logoRow}>
            <div style={S.logoMark}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                <path d="M3 21V3" stroke="#4F7A8F" strokeWidth="1.8" strokeLinecap="round"/>
                <path d="M3 21H21" stroke="#4F7A8F" strokeWidth="1.8" strokeLinecap="round"/>
                <path d="M3.5 17C7 17 8 6 13 6C17 6 16.5 13 20.5 13" stroke="#7BA3B8" strokeWidth="1.8" strokeLinecap="round" fill="none"/>
              </svg>
            </div>
            <div>
              <div style={S.logoText}>AP Physics 1 Hub</div>
        ...
        {mode !== "dashboard" && !globalReview && (
          <button style={S.unitSwitcher} className="mobile-only-switcher" onClick={() => setSidebarOpen(true)}>
            ...
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
              <path d="M4 6L12 14L20 6" stroke="#4F7A8F" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </button>
        )}
...
const S = {
  ...
  logoMark: { width: 36, height: 36, borderRadius: 11, background: "#E5EFF3", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 },
  ...
  modePillActive: { background: "#7BA3B8", color: "white" },
  ...
  unitSwitcherNum: { fontFamily: "'IBM Plex Mono',monospace", fontSize: 11.5, color: "#4F7A8F", fontWeight: 700 },
  ...
  unitBtnActive: { background: "#E5EFF3", border: "1px solid #B8D1AE" },
  unitBtnTop: { display: "flex", justifyContent: "space-between", marginBottom: 3 },
  unitNum: { fontFamily: "'IBM Plex Mono',monospace", fontSize: 10.5, color: "#4F7A8F", fontWeight: 700 },
  ...
  miniFill: { height: "100%", background: "#7BA3B8" },
  ...
  progressText: { fontFamily: "'Nunito',sans-serif", fontWeight: 700, fontSize: 13.5, color: "#4F7A8F" },
  progressTrack: { height: 7, background: "#E6E9E3", borderRadius: 4, overflow: "hidden" },
  progressFill: { height: "100%", background: "#7BA3B8", transition: "width 0.3s ease" },
  ...
  qNavBtn: { fontFamily: "'Nunito',sans-serif", fontWeight: 700, fontSize: 13.5, background: "#FFFFFF", color: "#4F7A8F", border: "1px solid #ECEAE3", padding: "10px 18px", borderRadius: 100, cursor: "pointer", boxShadow: "0 2px 8px rgba(70,90,60,0.05)" },
  ...
  unitBadge: { fontFamily: "'IBM Plex Mono',monospace", fontSize: 10.5, fontWeight: 700, color: "#4F7A8F", background: "#CCE1EA", borderRadius: 8, padding: "4px 8px", whiteSpace: "nowrap" },
  ...
  reviewAllCardClear: { background: "#E5EFF3" },
  reviewAllIconClear: { color: "#4F7A8F" },
  ...
  filterPillActive: { background: "#7BA3B8", color: "white" },
  ...
  qNumBadge: { fontFamily: "'IBM Plex Mono',monospace", fontSize: 11.5, fontWeight: 700, color: "#4F7A8F", background: "#CCE1EA", borderRadius: 8, padding: "4px 8px" },
  ...
  choiceCorrect: { background: "#E1EEDD", border: "1px solid #7BA3B8" },
  choiceWrong: { background: "#FBEAE5", border: "1px solid #D98B7B" },
  choiceDisabled: { opacity: 0.5, cursor: "default" },

  explanation: { marginTop: 14, padding: "13px 16px", background: "#E5EFF3", borderRadius: 12 },
  explanationLabel: { fontFamily: "'Nunito',sans-serif", fontWeight: 700, fontSize: 11, letterSpacing: "0.06em", textTransform: "uppercase", color: "#4F7A8F", marginBottom: 6 },
  ...
  frqPartLabel: { fontFamily: "'IBM Plex Mono',monospace", fontWeight: 700, fontSize: 12.5, color: "#4F7A8F", background: "#E5EFF3", display: "inline-block", padding: "3px 10px", borderRadius: 100, marginBottom: 8 },
  ...
  emptyIconBadge: { width: 56, height: 56, borderRadius: 18, background: "#E5EFF3", color: "#4F7A8F", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 16px" },
  ...
  dashCardValue: { fontFamily: "'Manrope',sans-serif", fontWeight: 800, fontSize: 28, color: "#4F7A8F" },
  ...
  dashUnitFill: { height: "100%", background: "#7BA3B8" },
  dashUnitActions: { display: "flex", gap: 8, marginTop: "auto" },
  dashJumpBtn: { fontFamily: "'Nunito',sans-serif", fontWeight: 700, fontSize: 12, background: "#E5EFF3", color: "#4F7A8F", border: "none", borderRadius: 100, padding: "6px 14px", cursor: "pointer" },
