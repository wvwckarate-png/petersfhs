...
const MCQ_STORAGE_KEY = "englang-hub-mcq-progress-v1";
const NAV_STORAGE_KEY = "englang-hub-last-nav-v1";
...
export default function EnglishLangPage() {
  ...
  return (
    <div style={S.page}>
      <style>{getEngineCSS(ENGLANG_COLORS)}</style>
      {/* TOP BAR */}
      <div style={S.topbar}>
          ...
          <div style={S.logoRow}>
            <div style={S.logoMark}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                <path d="M19 4C19 4 12 5 8 11C6 14 5 18 4.5 20C6.5 19.5 10 18 13 16C19 12 19 4 19 4Z" stroke="#966F1E" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M9.5 14.5L5 19" stroke="#966F1E" strokeWidth="1.6" strokeLinecap="round"/>
                <path d="M4.5 20L4 21.5" stroke="#966F1E" strokeWidth="1.4" strokeLinecap="round"/>
              </svg>
            </div>
            <div>
              <div style={S.logoText}>AP English Language Hub</div>
        ...
        {mode !== "dashboard" && !globalReview && (
          <button style={S.unitSwitcher} className="mobile-only-switcher" onClick={() => setSidebarOpen(true)}>
            ...
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
              <path d="M4 6L12 14L20 6" stroke="#966F1E" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </button>
        )}
...
const S = {
  ...
  logoMark: { width: 36, height: 36, borderRadius: 11, background: "#F7F0E1", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 },
  ...
  modePillActive: { background: "#C9992E", color: "white" },
  ...
  unitSwitcherNum: { fontFamily: "'IBM Plex Mono',monospace", fontSize: 11.5, color: "#966F1E", fontWeight: 700 },
  ...
  unitBtnActive: { background: "#F7F0E1", border: "1px solid #B8D1AE" },
  unitBtnTop: { display: "flex", justifyContent: "space-between", marginBottom: 3 },
  unitNum: { fontFamily: "'IBM Plex Mono',monospace", fontSize: 10.5, color: "#966F1E", fontWeight: 700 },
  ...
  miniFill: { height: "100%", background: "#C9992E" },
  ...
  progressText: { fontFamily: "'Nunito',sans-serif", fontWeight: 700, fontSize: 13.5, color: "#966F1E" },
  progressTrack: { height: 7, background: "#E6E9E3", borderRadius: 4, overflow: "hidden" },
  progressFill: { height: "100%", background: "#C9992E", transition: "width 0.3s ease" },
  ...
  qNavBtn: { fontFamily: "'Nunito',sans-serif", fontWeight: 700, fontSize: 13.5, background: "#FFFFFF", color: "#966F1E", border: "1px solid #ECEAE3", padding: "10px 18px", borderRadius: 100, cursor: "pointer", boxShadow: "0 2px 8px rgba(70,90,60,0.05)" },
  ...
  unitBadge: { fontFamily: "'IBM Plex Mono',monospace", fontSize: 10.5, fontWeight: 700, color: "#966F1E", background: "#EDDDBB", borderRadius: 8, padding: "4px 8px", whiteSpace: "nowrap" },
  ...
  reviewAllCardClear: { background: "#F7F0E1" },
  reviewAllIconClear: { color: "#966F1E" },
  ...
  filterPillActive: { background: "#C9992E", color: "white" },
  ...
  passageCard: { background: "#FCFAF3", border: "1px solid #EDDDBB", borderRadius: 16, padding: "18px 20px", marginBottom: 14 },
  passageLabel: { fontFamily: "'Nunito',sans-serif", fontWeight: 800, fontSize: 15, color: "#966F1E", marginBottom: 8 },
  passageIntro: { fontSize: 13.5, fontStyle: "italic", color: "#8A7752", marginBottom: 10 },
  passageText: { fontSize: 14.5, lineHeight: 1.7, color: "#3B4038", whiteSpace: "pre-wrap" },
  ...
  qNumBadge: { fontFamily: "'IBM Plex Mono',monospace", fontSize: 11.5, fontWeight: 700, color: "#966F1E", background: "#EDDDBB", borderRadius: 8, padding: "4px 8px" },
  ...
  choiceCorrect: { background: "#E1EEDD", border: "1px solid #C9992E" },
  choiceWrong: { background: "#FBEAE5", border: "1px solid #D98B7B" },
  choiceDisabled: { opacity: 0.5, cursor: "default" },

  explanation: { marginTop: 14, padding: "13px 16px", background: "#F7F0E1", borderRadius: 12 },
  explanationLabel: { fontFamily: "'Nunito',sans-serif", fontWeight: 700, fontSize: 11, letterSpacing: "0.06em", textTransform: "uppercase", color: "#966F1E", marginBottom: 6 },
  ...
  frqPartLabel: { fontFamily: "'IBM Plex Mono',monospace", fontWeight: 700, fontSize: 12.5, color: "#966F1E", background: "#F7F0E1", display: "inline-block", padding: "3px 10px", borderRadius: 100, marginBottom: 8 },
  ...
  emptyIconBadge: { width: 56, height: 56, borderRadius: 18, background: "#F7F0E1", color: "#966F1E", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 16px" },
  ...
  dashCardValue: { fontFamily: "'Manrope',sans-serif", fontWeight: 800, fontSize: 28, color: "#966F1E" },
  ...
  dashUnitFill: { height: "100%", background: "#C9992E" },
  dashUnitActions: { display: "flex", gap: 8, marginTop: "auto" },
  dashJumpBtn: { fontFamily: "'Nunito',sans-serif", fontWeight: 700, fontSize: 12, background: "#F7F0E1", color: "#966F1E", border: "none", borderRadius: 100, padding: "6px 14px", cursor: "pointer" },
